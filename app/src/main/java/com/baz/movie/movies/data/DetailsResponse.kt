...
data class DetailsResponse(@Json(name = "adult") val adult: Boolean,
...
data class ProductionCompany(@Json(name = "id") val id: Int,
                             @Json(name = "logo_path") val logoPath: Any,
                             @Json(name = "name") val name: String,
                             @Json(name = "origin_country") val originCountry: String)

data class ProductionCountry(@Json(name = "iso_3166_1") val iso31661: String,
                             @Json(name = "name") val name: String)

data class Genre(@Json(name = "id") val id: Int,
                 @Json(name = "name") val name: String)

data class SpokenLanguage(@Json(name = "iso_639_1") val iso6391: String,
                          @Json(name = "name") val name: String)